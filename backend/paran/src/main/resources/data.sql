<<<<<<< HEAD
INSERT INTO MEMBER (MEMBER_ID, PASSWORD, EMAIL, AGE, NICKNAME, GENDER, AUTHORITY) VALUES (1, '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', 'abc123@cdf.com', "20대",'admin', 'M', 'ROLE_ADMIN');
INSERT INTO MEMBER (MEMBER_ID, PASSWORD, EMAIL, AGE, NICKNAME, GENDER, AUTHORITY) VALUES (2, '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'cdf456@efg.com', "30대" ,'user', 'M', 'ROLE_USER');
...
INSERT INTO store (address, store_name, owner_name, phone, private_event, stamp)
    VALUES ("경기 수원시 팔달구 아주로 47번길 16", "미스터쉐프", "우영우", "010-1234-5678", true, false);

INSERT INTO store (address, store_name, owner_name, phone, private_event, stamp)
    VALUES ("경기 수원시 팔달구 아주로 13번길 19 골든파크", "아맛집", "동그라미", "010-5678-1234", false, true);
