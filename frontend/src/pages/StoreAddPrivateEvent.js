...
const StoreAddPrivateEvent = () => {
    ...
    return (
        <>
            <Header text="개인 이벤트 추가" link="/storePrivateEventList"></Header>
            <div className="container">
                <p style={{width: "327px", margin: "32px 0", fontSize: "19px"}}>개인 이벤트 추가</p>
                <div style={{position: "relative"}}>
                    <textarea className="eventForm"
                        value={newInfo}
                        onChange={e => setNewInfo(e.target.value)}
                        maxLength="152">    
                    </textarea>
                    <img style={{position: "absolute", right: "0", bottom: "6px", padding: "16px"}} alt="" src="images/edit_icon.png"></img>
                </div>
            </div>
